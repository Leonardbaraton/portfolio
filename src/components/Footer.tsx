...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-[#d2d2d7]/60 py-8 px-6">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <a
            ...
            className="text-[#aeaeb2] hover:text-[#0071e3] transition-colors text-sm"
          >
            Email
          </a>
          <a
            ...
            className="text-[#aeaeb2] hover:text-[#0071e3] transition-colors inline-flex items-center gap-1.5 text-sm"
          >
